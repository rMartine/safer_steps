const messages = {
  /* Language */
  welcome: "Bienvenido",
  chooseLanguage: "Seleccione lenguaje",
  ...
  staircase: "AGREGAR ESCALERA",
  stairNameOutdoors: "Outdoors-Main",
  edit: "Edit",
  upload: "Upload",

  emptyStairs: "No hay escaleras",

  /* Modal confirmation */
  uploadConfirmation: `Si presionas "Upload" tus respuestas de esta escalera be uploaded to the cloud consuming data. Do you agree?`,
  deleteConfirmation: `Si presionas "Delete" tus respuestas de esta escalera be deleted locally and from the server. Do you agree?`,
  delete: "Borrar",
  cancel: "Cancelar",
  uploading: "Subiendo",
  uploadingDescription:
    "Estamos subiendo tus respuestas to the cloud. In the meantime, you can close this modal to do other things.",
  close: "Cerrar",

  uploadCompleted: "Carga completada",
  uploadCompletedDescription:
    "Ya puedes cerrar este modal. It will close automatically in a few seconds...",

  /* Questions */
  question: "Pregunta",

  q0: "Please set a name to identify this staircase.",
  q1: "Estoy llenando esto por mí mismo (aquí vivo yo, sí señor).",
  q2:
