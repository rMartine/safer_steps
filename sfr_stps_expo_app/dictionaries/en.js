const messages = {
  ...
  /* Empty messages */
  emptyStairs: "There are no stairs registered yet",
  emptyStairsDescription:
    "If you want to add a staircase you can press the following button",
  ...
  /* Modal confirmation */
  uploadConfirmation: `If you press "Upload" your answers for this staircase will be uploaded to the cloud consuming data. Do you agree?`,
  deleteConfirmation: `If you press "Delete" your answers for this staircase will be deleted locally and from the server. Do you agree?`,
  delete: "Delete",
  cancel: "Cancel",
  uploading: "Uploading",
  uploadingDescription:
    "We are uploading your answers to the cloud. In the meantime, you can close this modal to do other things.",
  close: "Close",

  uploadCompleted: "Upload completed",
  uploadCompletedDescription:
    "You can close this modal now. It will close automatically in a few seconds...",

  /* Questions */
  question: "Question",

  q0: "Please set a name to identify this staircase.",
  q1: "I am filling this in for myself (this is my place of residence).",
  q2:
